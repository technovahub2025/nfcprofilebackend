...
${
  instagramUrl
    ? `<a href="${escapeHtml(
        instagramUrl
      )}" target="_blank" class="btn instagram">📷 Instagram</a>`
    : ""
}
...
${
  facebookUrl
    ? `<a href="${escapeHtml(
        facebookUrl
      )}" target="_blank" class="btn facebook">📘 Facebook</a>`
    : ""
}
...
${
  websiteUrl
    ? `<a href="${escapeHtml(
        websiteUrl
      )}" target="_blank" class="btn website">🌐 Website</a>`
    : ""
}
...
${
  googleBusinessUrl
    ? `<a href="${escapeHtml(
        googleBusinessUrl
      )}" target="_blank" class="btn website">🏢 Google Business</a>`
    : ""
}
...
function downloadContact() {
  ...
  link.href = ${JSON.stringify(vCardDataUri)};
